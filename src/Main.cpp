...
namespace
{
	...
	void CreateDefaultINI()
	{
		...
		std::string content =
			...
			"bReflexBoost=0\n"
			"\n"
			"; 0 = Native (DLAA, default), 1 = Quality DLSS (0.65x, 1.54x), 2 = Balanced (0.59x, 1.69x), 3 = Performance (0.5x, 2x)\n"
			"; ENB forces Native\n"
			"iQualityMode=0\n"
			"\n"
			"[Advanced]\n"
		...
		std::string content =
			...
			"fSharpness=0.5\n"
			"\n"
			"; 0 = Native (FSR 1.0x), 1 = Quality (0.65x, 1.54x), 2 = Balanced (0.59x, 1.69x), 3 = Performance (0.5x, 2x)\n"
			"; ENB forces Native\n"
			"iQualityMode=0\n"
			"\n"
			"[Advanced]\n"
		...
		std::string content =
			...
			"fSharpness=0.5\n"
			"\n"
			"; 0 = Native (XeSS 1.0x, default), 1 = Quality (0.65x, 1.54x), 2 = Balanced (0.59x, 1.69x), 3 = Performance (0.5x, 2x)\n"
			"; ENB forces Native\n"
			"iQualityMode=0\n"
			"\n"
			"[Advanced]\n"
		...
		std::string content =
			...
			"bReflexBoost=0\n"
			"\n"
			"; (*) 0 = Native (default), 1 = Quality (0.65x, 1.54x), 2 = Balanced (0.59x, 1.69x), 3 = Performance (0.5x, 2x)\n"
			"; ENB forces Native\n"
			"iQualityMode=0\n"
			"\n"
			"[Advanced]\n"
